...
public class FeedManager {
    ...
    public static AtomFeed readFeed(String url) throws Exception {
        InputStream input = new URL(url).openStream();

        return UjoManagerXML.getInstance()
            .parseXML(input, AtomFeed.class, "Reading from feed.");
    }

    public static AtomFeed readFeed(InputStream input) throws Exception {
        return UjoManagerXML.getInstance()
            .parseXML(input, AtomFeed.class, "Reading from feed.");
    }
}
